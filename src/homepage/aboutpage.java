...
//pl1.setBackground(new java.awt.Color(204, 204, 204));
    ...
    pane.add(about);  
     ...
     head.setFont(new java.awt.Font("Tahoma", 1, 40));
        ...
        String text="<html><p> E Health Care has emerged as India’s foremost integrated healthcare services provider and has a robust presence across the healthcare ecosystem, including Hospitals, Pharmacies, Primary Care & Diagnostic Clinics and several retail health models. The Group also has Telemedicine facilities across several states, Health Insurance Services, International Projects Consultancy, Medical Colleges, MEd varsity for E-Learning, Colleges of Nursing and Hospital Management and a Research Foundation.\n" +
"The cornerstones of Paradise Hospitals legacy are its unstinting focus on clinical excellence, affordable costs, modern technology and forward-looking research & academics. Paradise was among the first few hospitals in the India to leverage technology to facilitate seamless healthcare delivery.   \n" +
"As a responsible corporate citizen, Paradise Hospitals takes the spirit of leadership well beyond business and has embraced the responsibility of keeping India healthy. Recognizing that Non Communicable Diseases (NCDs) are the greatest threat to the nation, Paradise Hospitals is continuously educating people about preventive healthcare as the key to wellness. Likewise, the “Billion Hearts Beating Foundation” endeavors to keep Indians heart-healthy.\n" +
"Paradise Hospitals has championed numerous social initiatives – to cite a few which assist underprivileged children, which screens and provides pediatric cardiac care for congenital heart diseases. To introduce population health into the Indian narrative, It aims to provide “best healthcare” for the entire community starting from birth, through one’s journey into childhood, adolescence, adulthood and old age.</p></html>";
