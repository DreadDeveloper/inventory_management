...
public class contactpage extends JFrame {
    ...
    contactpage(){
        ...
        jsp=new JSplitPane();
        co.add(jsp);
        mail= new JButton("ehospital@gmail.com");
...
//pl1.setBackground(new java.awt.Color(204, 204, 204));
   ...
   JButton home = new JButton("Home");  
    ...
    pane.add(about);  
        ...
        String text="<html><p><center> ADDRESS <br> 239,Paradise hospital, Kolkata.<br><br>" + " Phone Number<br> +91 9455924591 (7 lines) <br><br>" + "E-mail ID<br><br></center>.</p></html>";
   ...
   logo.setBounds(0,10,400,152);
       ...
       patient.setBounds(170,360,200,100);
        ...
        tmail=new JLabel("ehospital@gmail.com");
